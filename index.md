...
- Non-Hermitian physics: Non-Hermitian physics studies quantum systems described by effective Hamiltonians that include gain and loss, and therefore are not Hermitian in the usual sense. While standard quantum mechanics requires Hermitian operators to guarantee real energies and unitary evolution, certain non-Hermitian (in particular, pseudo- or quasi-Hermitian) Hamiltonians can still have entirely real spectra and physically meaningful dynamics. My work investigates these systems as structured models of open quantum systems rather than mathematical anomalies. I have developed methods to define subsystems and reduced dynamics in such settings, where the usual tensor-product structure of Hilbert space can break down, and analyzed how gain–loss mechanisms modify entanglement, locality, and memory effects. By exploiting the mathematical equivalence between certain non-Hermitian and Hermitian descriptions, I am currently interested in knowing whether open-system implementations can offer advantages in Hamiltonian simulating. Find my PhD thesis on this topic  <a href="https://www.imsc.res.in/xmlui/handle/123456789/901" target="blank">here</a>
